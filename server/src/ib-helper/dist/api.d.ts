...
export declare type TrueFalse = 't' | 'f';
export declare type OrAnd = 'or' | 'and';
export declare type SubmissionType = 'Picture/Pinup' | 'Sketch' | 'Picture Series' | 'Comic' | 'Portfolio' | 'Shockwave/Flash - Animation' | 'Shockwave/Flash - Interactive' | 'Video - Feature Length' | 'Video - Animation/3D/CGI' | 'Music - Album' | 'Writing - Document' | 'Character Sheet' | 'Photography';
export declare type OrderType = 'create_datetime' | 'last_file_update_datetime' | 'unread_datetime' | 'unread_datetime_reverse' | 'views' | 'total_print_sales' | 'total_digital_sales' | 'total_sales' | 'username' | 'fav_datetime' | 'fav_stars' | 'pool_order';
...
export declare const api: {
  ...
  rating: (params: RatingRequest) => Promise<RatingResponse>;
  search: (params: SearchRequest) => Promise<SearchResponse>;
  searchRid: (params: SearchRIDRequest) => Promise<SearchResponse>;
  details: (params: DetailsRequest) => Promise<DetailsResponse>;
};
export default api;
